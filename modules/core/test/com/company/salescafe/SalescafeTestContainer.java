...
public class SalescafeTestContainer extends TestContainer {

    public SalescafeTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/salescafe/app.properties",
    ...
    public static class Common extends SalescafeTestContainer {

        public static final SalescafeTestContainer.Common INSTANCE = new SalescafeTestContainer.Common();
